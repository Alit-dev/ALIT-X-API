...
const meta = {
  name: "gpt-4-1-nano",
  version: "1.0.0",
  description: "Uses model: provider-4/gpt-4.1-nano. This API enables lightweight and fast AI chat completion, suitable for Q&A, small text generation, and quick responses.",
  author: "Alamin",
  method: "get",
  category: "open-ai",
  path: "/gpt-4-1-nano?text="
};

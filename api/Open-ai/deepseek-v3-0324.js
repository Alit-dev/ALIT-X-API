...
const meta = {
  ...
  version: "1.0.0",
  description: "Uses model: provider-4/deepseek-v3-0324. This API further improves deep data extraction and search results with the latest updates.",
  author: "Alamin",
  method: "get",
  category: "ai",
  path: "/deepseek-v3-0324?text="
};
...
async function onStart({ req, res }) {
  ...
  try {
    const response = await axios.post(
      ...
      {
        model: "provider-4/deepseek-v3-0324",
        messages: [
          { role: "system", content: "You are a deep data extraction assistant." },

...
const meta = {
  name: "deepseek-v3",
  version: "1.0.0",
  description: "Uses model: provider-4/deepseek-v3. This API enhances deep data searching capabilities with updated algorithms for better results.",
  author: "Alamin",
  method: "get",
  category: "ai",
  path: "/deepseek-v3?text="
};
